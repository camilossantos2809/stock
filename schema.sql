...
CREATE USER 'stock'@'%';
ALTER USER 'stock'@'%'
    IDENTIFIED WITH mysql_native_password BY '123456789';
GRANT Create role ON *.* TO 'stock'@'%';
GRANT Create user ON *.* TO 'stock'@'%';
GRANT Drop role ON *.* TO 'stock'@'%';
GRANT Event ON *.* TO 'stock'@'%';
GRANT File ON *.* TO 'stock'@'%';
GRANT Process ON *.* TO 'stock'@'%';
GRANT Reload ON *.* TO 'stock'@'%';
GRANT Replication client ON *.* TO 'stock'@'%';
GRANT Replication slave ON *.* TO 'stock'@'%';
GRANT Show databases ON *.* TO 'stock'@'%';
GRANT Shutdown ON *.* TO 'stock'@'%';
GRANT Super ON *.* TO 'stock'@'%';
GRANT Create tablespace ON *.* TO 'stock'@'%';
GRANT Usage ON *.* TO 'stock'@'%';
GRANT XA_RECOVER_ADMIN ON *.* TO 'stock'@'%';
GRANT PERSIST_RO_VARIABLES_ADMIN ON *.* TO 'stock'@'%';
GRANT GROUP_REPLICATION_ADMIN ON *.* TO 'stock'@'%';
GRANT SYSTEM_USER ON *.* TO 'stock'@'%';
GRANT APPLICATION_PASSWORD_ADMIN ON *.* TO 'stock'@'%';
GRANT SET_USER_ID ON *.* TO 'stock'@'%';
GRANT SESSION_VARIABLES_ADMIN ON *.* TO 'stock'@'%';
GRANT BINLOG_ADMIN ON *.* TO 'stock'@'%';
GRANT BINLOG_ENCRYPTION_ADMIN ON *.* TO 'stock'@'%';
GRANT ENCRYPTION_KEY_ADMIN ON *.* TO 'stock'@'%';
GRANT SYSTEM_VARIABLES_ADMIN ON *.* TO 'stock'@'%';
GRANT REPLICATION_SLAVE_ADMIN ON *.* TO 'stock'@'%';
GRANT RESOURCE_GROUP_ADMIN ON *.* TO 'stock'@'%';
GRANT RESOURCE_GROUP_USER ON *.* TO 'stock'@'%';
GRANT BACKUP_ADMIN ON *.* TO 'stock'@'%';
GRANT CONNECTION_ADMIN ON *.* TO 'stock'@'%';
GRANT ROLE_ADMIN ON *.* TO 'stock'@'%';
GRANT TABLE_ENCRYPTION_ADMIN ON *.* TO 'stock'@'%';
GRANT SERVICE_CONNECTION_ADMIN ON *.* TO 'stock'@'%';
GRANT Alter ON *.* TO 'stock'@'%';
GRANT Create ON *.* TO 'stock'@'%';
GRANT Create view ON *.* TO 'stock'@'%';
GRANT Delete ON *.* TO 'stock'@'%';
GRANT Drop ON *.* TO 'stock'@'%';
GRANT Grant option ON *.* TO 'stock'@'%';
GRANT Index ON *.* TO 'stock'@'%';
GRANT Insert ON *.* TO 'stock'@'%';
GRANT References ON *.* TO 'stock'@'%';
GRANT Select ON *.* TO 'stock'@'%';
GRANT Show view ON *.* TO 'stock'@'%';
GRANT Trigger ON *.* TO 'stock'@'%';
GRANT Update ON *.* TO 'stock'@'%';
GRANT Alter routine ON *.* TO 'stock'@'%';
GRANT Create routine ON *.* TO 'stock'@'%';
GRANT Create temporary tables ON *.* TO 'stock'@'%';
GRANT Execute ON *.* TO 'stock'@'%';
GRANT Lock tables ON *.* TO 'stock'@'%';
FLUSH PRIVILEGES;
